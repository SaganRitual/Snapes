...
struct BarChartDataBackdrop: View {
    ...
    var body: some View {
        ZStack {
            GeometryReader { gr in
                ...
                BarChartBarsView(viewWidth: gr.size.width, viewHeight: gr.size.height)
...
struct BarChartDataBackdrop_Previews: PreviewProvider {
    static var previews: some View {
        BarChartDataBackdrop().frame(width: 500, height: 200)
    }
}
